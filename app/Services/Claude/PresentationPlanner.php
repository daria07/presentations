...
class PresentationPlanner
{
    ...
    private function outlineSystemPrompt(int $slideCount, bool $fromText): string
    {
        ...
        - В bullets поле title — два-четыре слова, text — одно предложение
          до 120 знаков. Высота слайда фиксирована: четыре длинных
          описания в него не влезают, и лишнее просто обрежется.
          Лучше разнести на два слайда, чем уместить всё в один.
