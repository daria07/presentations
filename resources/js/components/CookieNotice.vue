...
// Технические куки (сессия и CSRF) отключить нельзя — без сессии не
// будет входа, — а статистика посещений обезличена и настраивается в
// браузере. Поэтому это уведомление, а не согласие: одна кнопка
// «Понятно», без выбора и без блокировки содержимого.
