...
const steps = [
    {
        title: 'Опишите тему',
        text: 'Одной строкой, своими словами. «Пётр I и его реформы для восьмого класса» — этого достаточно.',
    },
    {
    ...
    <div class="landing bg-paper text-foreground min-h-screen">
        ...
        <section class="mx-auto max-w-5xl px-6 pt-20 pb-16 md:pt-28">
            ...
            <p class="text-muted-foreground mt-7 max-w-[52ch] text-lg leading-relaxed">
                ...
                структурой. Не текст, который ещё предстоит разложить по слайдам,
                а готовый файл.
            </p>
